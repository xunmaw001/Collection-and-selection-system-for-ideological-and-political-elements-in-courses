...
<body>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			row.appendChild(checkbox)
				  ...
				  tupianCell.appendChild(tupianImg);
									...
									row.appendChild(tupianCell);
				            				var zhishidianCell  = document.createElement('td');

												  if(item.zhishidian != null && item.zhishidian != "" && item.zhishidian.length >= 11){
				  	zhishidianCell.innerHTML = item.zhishidian.substring(0, 10) + "..."; 
				  }else{
				  	zhishidianCell.innerHTML = item.zhishidian;
				  }

				
									row.appendChild(zhishidianCell);
            ...
            crossBtn1.innerHTML = "加入课程"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"jiarukecheng\")");
			if(crossBtnControl('加入课程') == true){
