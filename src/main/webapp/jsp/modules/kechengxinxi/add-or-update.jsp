...
<body>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input name="tupian" id="tupian-input" type="hidden">
											...
											<div class="form-group col-md-6">
										<label>知识点</label>
										<textarea name="zhishidian" class="form-control" id="zhishidian" rows="3"></textarea>
									</div>
													<div class="form-group col-md-6">
										<label>工号</label>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		...
		function getContent(){
					...
					$('#kechengxiangqing-input').attr('value',UE.getEditor('kechengxiangqingEditor').getPlainTxt());
				}
																				}
					...
					for(var kechengleixingCount = 0; kechengleixingCount < kechengleixingOptions.length;kechengleixingCount++){
						if(kechengleixingOptions[kechengleixingCount].getAttribute('value') == ruleForm.kechengleixing){
							kechengleixingOptions[kechengleixingCount].setAttribute('selected','selected');
																...
																$("#zhishidian").val(ruleForm.zhishidian);
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
								...
								$("#tupian-input").val(res.data.tupian);
												...
												if(res.data != null && res.data != '' && res.data.zhishidian != null && res.data.zhishidian != ''){

															$("#zhishidian").val(res.data.zhishidian);
													}
