...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">加入课程管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">加入课程列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">加入课程列表</h3>							
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
												...
												<input type="text" id="kechengmingchengSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
																																																														...
																																																														<label>
												课程类型
												<input type="text" id="kechengleixingSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('kechengmingcheng')">课程名称<i id="kechengmingchengIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('sizhengyuansu')">思政元素<i id="sizhengyuansuIcon" class="fa fa-sort"></i></th>
	...
	<script>
			...
			row.appendChild(checkbox)
							...
							var kechengmingchengCell  = document.createElement('td');
									...
									row.appendChild(jiaoshixingmingCell);
				            				var sizhengyuansuCell  = document.createElement('td');

												  //如果图文详情包含图片
				  if(item.sizhengyuansu && item.sizhengyuansu.indexOf('img') != -1){
					//暂时只考虑图片+文字 和 文字+图片的情况
					var beginIndex = item.sizhengyuansu.indexOf('<img');
					var endIndex = item.sizhengyuansu.indexOf('>');				
					sizhengyuansuCell.innerHTML = item.sizhengyuansu.substring(beginIndex, endIndex+1).replace("img","img width='100' height='100'");				
				  }else{
				  	 if(item.sizhengyuansu != null && item.sizhengyuansu != "" && item.sizhengyuansu.length >= 11){
				  		sizhengyuansuCell.innerHTML = item.sizhengyuansu.substring(0, 10) + "..."; 
				  	}else{
				  		sizhengyuansuCell.innerHTML = item.sizhengyuansu;
				 	}
				  }
				  

                
									row.appendChild(sizhengyuansuCell);
		...
		function sh(){
			...
			httpJson("jiarukecheng/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jiarukecheng/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"jiarukecheng");
